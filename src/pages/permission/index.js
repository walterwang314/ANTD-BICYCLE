...
const CreateRoleForm = Form.create({})(RoleForm);
...
const CreatePermEditForm = Form.create({})(PermEditForm);
...
const CreateRoleAuthForm = Form.create({})(RoleAuthForm);
